        ...
        <div className="border-b bg-gray-50">
            <div className="relative max-w-7xl mx-auto overflow-hidden border-x">
                <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
                    <div className="pl-6 pr-6 md:mr-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
                        <h2 className="text-base  leading-7 text-orange-400">Stal zbrojeniowa i zbrojenie budowlane</h2>
                        <p className="mt-2 text-3xl  tracking-tight sm:text-4xl">Produkcja prefabrykatów zbrojeniowych</p>
                    ...
                    <div className="relative h-80 overflow-hidden bg-black md:absolute md:right-0 md:h-full md:w-1/3 lg:w-1/2">
                        <Image
