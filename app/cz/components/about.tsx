            ...
            <div className="relative max-w-7xl mx-auto overflow-hidden border-x">
                ...
                <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
                    <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
                        <h2 className="text-base  leading-7 text-orange-400">Betonářská ocel a konstrukční výztuže</h2>
                        <h3 className="mt-2 text-3xl  tracking-tight sm:text-4xl">Výroba prefabrikovaných výztužných prvků</h3>
                        <p className="mt-6 text-base leading-7">
                        Naše armatura zahrnuje výrobu prefabrikátů z tyčí o průměrech od 6 mm do 40 mm. Používáme ocel B500A, B500B a B500SP.
                        </p>
                        <div className="mt-8">
                            <a
                                href="/cz/nabidka/"
