            ...
            <div className="bg-white border-b">
                <div className="mx-auto max-w-7xl px-6 lg:px-8 border-x py-24 sm:py-32">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        <h2 className="text-3xl  tracking-tight text-gray-900">Kontaktní stavební výztuhy</h2>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                        Kontaktujte prosím naši posilovnu. Naši specialisté čekají na dotazy k nabídce ocelových výrobků.
                        </p>
                    </div>
                    <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
                        ...
                        <div>
                            <h3 className="border-l border-orange-600 pl-6  text-gray-900">Podnikání</h3>
                            <address className="border-l border-gray-200 pl-6 pt-2 not-italic text-gray-600">
                                <p>TRANSBET BETONIARNIE GROCHOWICZ Sp. K.</p>
                            </address>
                        </div>
                        <div>
                            <h3 className="border-l border-orange-600 pl-6  text-gray-900">Data</h3>
                            <address className="border-l border-gray-200 pl-6 pt-2 not-italic text-gray-600">
