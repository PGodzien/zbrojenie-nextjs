...
export default function Feature() {
    return (
        <div className="relative bg-white max-w-7xl mx-auto my-24 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
                <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
                    ...
                    <div className="mt-8">
                        <a
                            href="#"
                            className="rounded-3xl bg-black px-6 py-4 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
                        >
                            Cała oferta
                        </a>
                    </div>
